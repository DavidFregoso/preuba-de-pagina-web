	...
	<body>
		...
		<div class="ratio ratio-16x9">
			<video autoplay loop muted playsinline>
	  			<source src="videos/bano-botanico.mp4" type="video/mp4"></source>
	  		</video>
	  	</div>
		<section class="landing-verde">
			<div class="container">
				<div class="row mb-5 text-black">
					<div class="col text-center">
						<h1>Conoce nuestra línea para toda la familia con la mejor relación calidad-precio de Baño Botánico</h1>
					</div>
				</div>
				<div class="row text-white">
					<div class="col-md-6 mb-3">
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<img src="images/ico-bb-anticaida.webp" class="img-fluid">
							</div>
							<div class="col-md-6">
								<h5>Shampoo Anticaída</h5>
								<ul class="list-unstyled">
									<li>Protege el cabello contra el envejecimiento prematuro</li>
									<li>Limpia el cuero cabelludo del exceso de grasa</li>
									<li>Permite una mejor irrigación de nutrientes en el cuero cabelludo</li>
									<li>Crecimiento del cabello con mayor vigor, volumen y fuerza</li>
								</ul>
								<p>Presentación: 1L</p>
								<a href="https://www.omoyalorganica.com.mx/shampoo-bano-botanico-extracto-de-romero-anticaida-1-lt/p/MLM28953158?pdp_filters=seller_id%3A135117048#position=1&search_layout=grid&type=item&tracking_id=8faea37c-0837-4f26-8d16-ce410d49047b" target="_blank" rel="nofollow"><img src="images/ico-landing-cart.webp"></a>
								<a href="https://api.whatsapp.com/send/?phone=523222367754&text&type=phone_number&app_absent=0" target="_blank" rel="nofollow" class="btn btn-success">
					...
					<div class="col-md-6 mb-3">
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<img src="images/ico-bb-crecimiento.webp" class="img-fluid">
							</div>
							<div class="col-md-6">
								<h5>Shampoo Crecimiento</h5>
								<ul class="list-unstyled">
									<li>Estimula la circulación sanguínea en el cuero cabelludo</li>
									<li>Promueve el crecimiento vigoroso del cabello</li>
								</ul>
								<p>Presentación: 1L</p>
								<a href="https://www.omoyalorganica.com.mx/shampoo-bano-botanico-extracto-de-jengibre-crecimiento1-lt/p/MLM29817683?pdp_filters=seller_id:135117048#position=2&search_layout=grid&type=item&tracking_id=105c4aab-875c-49d7-a1ed-366aff8c52f9" target="_blank" rel="nofollow"><img src="images/ico-landing-cart.webp"></a>
								<a href="https://api.whatsapp.com/send/?phone=523222367754&text&type=phone_number&app_absent=0" target="_blank" rel="nofollow" class="btn btn-success">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
										<path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/>
									</svg>
					...
					<div class="col-md-6 mb-3">
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<img src="images/ico-bb-rejuvenecedor-y-refrescante.webp" class="img-fluid">
							</div>
							<div class="col-md-6">
								<h5>Shampoo Rejuvenecedor y Refrescante</h5>
								<ul class="list-unstyled">
									<li>Protege el cabello contra el envejecimiento prematuro</li>
									<li>Limpia el cuero cabelludo del exceso de grasa</li>
									<li>Estimula, purifica y refresca los folículos capilares</li>
									<li>Aporta mayor brillo al cabello</li>
									<li>Tonifica el cuero cabelludo</li>
								</ul>
								<p>Presentación: 1L</p>
								<a href="https://www.omoyalorganica.com.mx/MLM-1483791612-shampoo-bano-botanico-eucaliptoromero-rejuvenecedor-1-lt-_JM#position=3&search_layout=grid&type=item&tracking_id=f29cb5e1-8343-406e-8e64-8be71d956699" target="_blank" rel="nofollow"><img src="images/ico-landing-cart.webp"></a>
								<a  href="https://api.whatsapp.com/send/?phone=523222367754&text&type=phone_number&app_absent=0" target="_blank" rel="nofollow" class="btn btn-success">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
										<path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/>
									</svg>
							...
							<div class="carousel-inner" role="listbox">
								<div class="carousel-item active">
									<div class="col-md-6 p-3">
										<img src="images/promocion-03.webp" class="img-fluid">
									</div>
								</div>
								<div class="carousel-item">
									<div class="col-md-6 p-3">
										<img src="images/promocion-04.webp" class="img-fluid">
									</div>
								</div>
							</div>
		...
		<section class="giveaway" id="giveaway">
			<div class="container-fluid">
				<div class="row mb-5">
					<div class="col">
						<img src="images/giveaway-bano-botanico-3.webp" class="img-fluid">
					</div>
				</div>
			</div>
			<div class="container">
				<form id="frmGiveaway" class="was-validated">
					<input type="hidden" id="marca" name="marca" value="bano-botanico">
					<div class="row mb-5">
						<div class="col text-center">
							<h1>¡Participa y gana pases dobles!</h1>
						</div>
					</div>
					<div class="row mb-3">
						<div class="col">
